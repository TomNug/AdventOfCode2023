...
### My Approach
Using regex to parse the lines to extract cards, winning numbers, and numbers. Stored this data within a class for each card.
Numbers and winning numbers were stored in HashSets, this made finding winning numbers easy with intersections.
...
### My Approach
Created a class to manage the whole pool of cards.
Made a dictionary of possible cards for easy additions of copies of cards.
Stored a list of cards, and processed each one, determining how many cards were needed, and using the dictionary to add them.
